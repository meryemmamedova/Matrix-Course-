...
*/
        ...
        int month = 4;
        String sesaonName = switch (month) {
 ...
 // Ev tapsirigi:
       ...
       /* System.out.print("Ededi daxil edin: ");
        ...
        System.out.print("Reqemlerinin cemi: " + sum);
        bonus task eve (fibonacci sirasi for ile hem de while ile) ---
        ...
        while (true) {
            ...
            System.out.println("2. Cix");
            System.out.println("3. Vur");
            System.out.println("4. Bol");
            System.out.println("5. Xeta");
       ...
       /* for (int i = 1; i <= 4; i++) {
        ...
        //Bunu sorus : System.out.println("Ededi qeyd edin: ");
        //int eded = sc.nextInt();
        //int sum = 0;
        //while (eded > 0) {
